package com.example.globalgaming.ui.settings.termsAndConditions;
...
import com.example.globalgaming.databinding.FragmentTermsAndConditionsBinding;
...
public class TermsAndConditionsFragment extends Fragment {
    ...
    private void goToSettingsFragment() {
        navController.navigate(R.id.action_termsAndConditionsFragment_to_settingsFragment);
    }
